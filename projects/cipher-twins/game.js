...
// Resolving a round hashes the shared guess with SHA-256 and compares it to
// the manifest hash. `crypto.subtle` only exists in a secure context — HTTPS
// or localhost — so on a plain-HTTP LAN preview opened from another computer
// it is undefined and the digest call throws. Fall back to a small self
// contained implementation there so a same-network playtest still resolves.
